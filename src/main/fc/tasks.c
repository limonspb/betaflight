...
task_attribute_t task_attributes[TASK_COUNT] = {
    ...
    [TASK_BATTERY_VOLTAGE] = DEFINE_TASK("BATTERY_VOLTAGE", NULL, NULL, batteryUpdateVoltage, TASK_PERIOD_HZ(200), TASK_PRIORITY_MEDIUM), // Freq may be updated in tasksInit
