...
{
    pidRuntime.tpaSpeedEst.twr = pidProfile->tpa_speed_est_adv_twr / 100.0f;
    ...
    pidRuntime.tpaSpeedEst.propMaxSpeed = 0.0004233f * pidProfile->tpa_speed_est_adv_prop_pitch * motorConfig()->kv * pidRuntime.tpaSpeedEst.maxVoltage;
