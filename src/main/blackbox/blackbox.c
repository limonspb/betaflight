...
static bool blackboxWriteSysinfo(void)
{
    ...
    switch (xmitState.headerIndex) {
        ...
        BLACKBOX_PRINT_HEADER_LINE("s_roll",  "%d", currentPidProfile->pid[PID_ROLL]  .S);
        BLACKBOX_PRINT_HEADER_LINE("s_pitch", "%d", currentPidProfile->pid[PID_PITCH] .S);
        BLACKBOX_PRINT_HEADER_LINE("s_yaw",   "%d", currentPidProfile->pid[PID_YAW]   .S);
        ...
        BLACKBOX_PRINT_HEADER_LINE(PARAM_NAME_GYRO_ROLL_LPF_STATIC_HZ, "%d",  gyroConfig()->gyro_rpy_lpf_static_hz[X]);
        BLACKBOX_PRINT_HEADER_LINE(PARAM_NAME_GYRO_PITCH_LPF_STATIC_HZ, "%d", gyroConfig()->gyro_rpy_lpf_static_hz[Y]);
        BLACKBOX_PRINT_HEADER_LINE(PARAM_NAME_GYRO_YAW_LPF_STATIC_HZ, "%d",   gyroConfig()->gyro_rpy_lpf_static_hz[Z]);

        BLACKBOX_PRINT_HEADER_LINE(PARAM_NAME_GYRO_ROLL_LPF_TYPE, "%d",  gyroConfig()->gyro_rpy_lpf_type[X]);
        BLACKBOX_PRINT_HEADER_LINE(PARAM_NAME_GYRO_PITCH_LPF_TYPE, "%d", gyroConfig()->gyro_rpy_lpf_type[Y]);
        BLACKBOX_PRINT_HEADER_LINE(PARAM_NAME_GYRO_YAW_LPF_TYPE, "%d",   gyroConfig()->gyro_rpy_lpf_type[Z]);
