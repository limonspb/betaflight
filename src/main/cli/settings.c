...
// PG_GYRO_CONFIG
    ...
    { PARAM_NAME_PTERM_ROLL_LPF_STATIC_HZ,  VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0,  LPF_MAX_HZ }, PG_PID_PROFILE, offsetof(pidProfile_t, pterm_lpf_static_hz[X]) },
    { PARAM_NAME_PTERM_PITCH_LPF_STATIC_HZ, VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0,  LPF_MAX_HZ }, PG_PID_PROFILE, offsetof(pidProfile_t, pterm_lpf_static_hz[Y]) },
    { PARAM_NAME_PTERM_YAW_LPF_STATIC_HZ,   VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0,  LPF_MAX_HZ }, PG_PID_PROFILE, offsetof(pidProfile_t, pterm_lpf_static_hz[Z]) },

    { PARAM_NAME_PTERM_ROLL_LPF_TYPE,       VAR_UINT8  | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_GYRO_LPF_TYPE }, PG_PID_PROFILE, offsetof(pidProfile_t, pterm_lpf_type[X]) },
    { PARAM_NAME_PTERM_PITCH_LPF_TYPE,      VAR_UINT8  | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_GYRO_LPF_TYPE }, PG_PID_PROFILE, offsetof(pidProfile_t, pterm_lpf_type[Y]) },
    { PARAM_NAME_PTERM_YAW_LPF_TYPE,        VAR_UINT8  | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_GYRO_LPF_TYPE }, PG_PID_PROFILE, offsetof(pidProfile_t, pterm_lpf_type[Z]) },
...
// PG_SERVO_CONFIG
    ...
    { "custom_servo_rate",          VAR_INT8   | MASTER_VALUE, .config.minmax = { -100, 100 }, PG_SERVO_CONFIG, offsetof(servoConfig_t, custom_servo_rate) },
    { "fake_flaps_value",           VAR_INT16  | MASTER_VALUE, .config.minmax = { -1000, 1000 }, PG_SERVO_CONFIG, offsetof(servoConfig_t, fake_flaps_value) },
#endif
...
// PG_PID_PROFILE
    ...
    { "s_pitch",                    VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, PID_GAIN_MAX }, PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_PITCH].S) },
    { "s_roll",                     VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, PID_GAIN_MAX }, PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_ROLL].S) },
    { "s_yaw",                      VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, PID_GAIN_MAX }, PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_YAW].S) },
    ...
    { PARAM_NAME_TPA_LOW_RATE,            VAR_INT8  | PROFILE_VALUE, .config.minmaxUnsigned = { INT8_MIN, TPA_MAX}, PG_PID_PROFILE, offsetof(pidProfile_t, tpa_low_rate) },
    ...
    { PARAM_NAME_ITERM_RAW_GYRO,     VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, iterm_raw_gyro) },
