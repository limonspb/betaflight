...
// PG_GYRO_CONFIG
    ...
    { PARAM_NAME_GYRO_ROLL_LPF_STATIC_HZ,  VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0,  LPF_MAX_HZ }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_rpy_lpf_static_hz[X]) },
    { PARAM_NAME_GYRO_PITCH_LPF_STATIC_HZ, VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0,  LPF_MAX_HZ }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_rpy_lpf_static_hz[Y]) },
    { PARAM_NAME_GYRO_YAW_LPF_STATIC_HZ,   VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0,  LPF_MAX_HZ }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_rpy_lpf_static_hz[Z]) },

    { PARAM_NAME_GYRO_ROLL_LPF_TYPE,       VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_GYRO_LPF_TYPE }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_rpy_lpf_type[X]) },
    { PARAM_NAME_GYRO_PITCH_LPF_TYPE,      VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_GYRO_LPF_TYPE }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_rpy_lpf_type[Y]) },
    { PARAM_NAME_GYRO_YAW_LPF_TYPE,        VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_GYRO_LPF_TYPE }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_rpy_lpf_type[Z]) },
...
// PG_OSD_CONFIG
    ...
    { "extra_osd_use_quick_menu",   VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, extra_osd_use_quick_menu) },
    { "extra_osd_show_spec",        VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, extra_osd_show_spec) },
