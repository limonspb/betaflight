...
#endif
    { "dterm_llc_freq_hz",          VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 1, LPF_MAX_HZ }, PG_PID_PROFILE, offsetof(pidProfile_t, dterm_llc_freq_hz) },
    { "dterm_llc_phase",            VAR_INT8   | MASTER_VALUE, .config.minmax =         { -90, 90 },       PG_PID_PROFILE, offsetof(pidProfile_t, dterm_llc_phase) },
    { "pterm_llc_freq_hz",          VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 1, LPF_MAX_HZ }, PG_PID_PROFILE, offsetof(pidProfile_t, pterm_llc_freq_hz) },
    { "pterm_llc_phase",            VAR_INT8   | MASTER_VALUE, .config.minmax =         { -90, 90 },       PG_PID_PROFILE, offsetof(pidProfile_t, pterm_llc_phase) },
