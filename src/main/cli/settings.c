...
// PG_MIXER_CONFIG
    ...
    { "rpm_limiter_p",                  VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 0, 1000 }, PG_MIXER_CONFIG, offsetof(mixerConfig_t, rpm_limiter_p) },
    { "rpm_limiter_i",                  VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 0, 1000 }, PG_MIXER_CONFIG, offsetof(mixerConfig_t, rpm_limiter_i) },
    { "rpm_limiter_d",                  VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 0, 100 }, PG_MIXER_CONFIG, offsetof(mixerConfig_t, rpm_limiter_d) },
    { "rpm_limit",                      VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 0, 1000 }, PG_MIXER_CONFIG, offsetof(mixerConfig_t, rpm_limiter_rpm_limit) },
    { "rpm_limiter_accel_limit",        VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 1, 1000 }, PG_MIXER_CONFIG, offsetof(mixerConfig_t, rpm_limiter_acceleration_limit) },
...
// PG_PID_PROFILE
    ...
    { "extra_motor_output_limit_hundredths", VAR_UINT8 | PROFILE_VALUE,  .config.minmaxUnsigned = { 0, 99 }, PG_PID_PROFILE, offsetof(pidProfile_t, extra_motor_output_limit_hundredths) },
...
// PG_LED_STRIP_CONFIG
    ...
    { "extra_ledstrip_3colors",     VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_LED_STRIP_CONFIG, offsetof(ledStripConfig_t, extraLedstrip3Colors) },
#endif
...
// position as displayed in the GUI.
    { "osd_warn_bitmaks",    VAR_UINT32 | MASTER_VALUE, .config.u32Max = UINT32_MAX, PG_OSD_CONFIG, offsetof(osdConfig_t, enabledWarnings) },
