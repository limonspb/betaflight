...
#endif // USE_WING undefined

#ifdef USE_WING
    { PARAM_NAME_GPS_RESCUE_WING_ALT_P,      VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, ap_wing_alt_p) },
    { PARAM_NAME_GPS_RESCUE_WING_ALT_I,      VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, ap_wing_alt_i) },
    { PARAM_NAME_GPS_RESCUE_WING_ALT_D,      VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, ap_wing_alt_d) },

    { PARAM_NAME_GPS_RESCUE_WING_COG_P,      VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, ap_wing_cog_p) },
    { PARAM_NAME_GPS_RESCUE_WING_COG_I,      VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, ap_wing_cog_i) },
    { PARAM_NAME_GPS_RESCUE_WING_COG_D,      VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, ap_wing_cog_d) },
...
// PG_PID_PROFILE
    ...
    { PARAM_NAME_TPA_SPEED_BASIC_DELAY, VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 1, UINT16_MAX}, PG_PID_PROFILE, offsetof(pidProfile_t, tpa_speed_est_basic_delay) },
    { PARAM_NAME_TPA_SPEED_BASIC_GRAVITY, VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 1, UINT16_MAX}, PG_PID_PROFILE, offsetof(pidProfile_t, tpa_speed_est_basic_gravity) },
    { PARAM_NAME_TPA_SPEED_EST_ADV_PROP_PITCH, VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 1, UINT16_MAX}, PG_PID_PROFILE, offsetof(pidProfile_t, tpa_speed_est_adv_prop_pitch) },
    { PARAM_NAME_TPA_SPEED_EST_ADV_MASS, VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 1, UINT16_MAX}, PG_PID_PROFILE, offsetof(pidProfile_t, tpa_speed_est_adv_mass) },
    { PARAM_NAME_TPA_SPEED_EST_ADV_DRAG_K, VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 1, UINT16_MAX}, PG_PID_PROFILE, offsetof(pidProfile_t, tpa_speed_est_adv_drag_k) },
    { PARAM_NAME_TPA_SPEED_EST_ADV_THRUST, VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 1, UINT16_MAX}, PG_PID_PROFILE, offsetof(pidProfile_t, tpa_speed_est_adv_thrust) },
    ...
    { PARAM_NAME_TPA_SPEED_EST_PITCH_OFFSET, VAR_INT16 | PROFILE_VALUE, .config.minmaxUnsigned = { INT16_MIN, INT16_MAX}, PG_PID_PROFILE, offsetof(pidProfile_t, tpa_speed_est_pitch_offset) },
#endif // USE_WING
    ...
    { PARAM_NAME_ANGLE_PITCH_OFFSET, VAR_INT8 | PROFILE_VALUE, .config.minmaxUnsigned = { INT8_MIN, INT8_MAX }, PG_PID_PROFILE, offsetof(pidProfile_t, angle_pitch_offset) },
#endif
